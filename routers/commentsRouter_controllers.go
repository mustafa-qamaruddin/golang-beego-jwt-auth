...
func init() {
	...
	beego.GlobalControllerRouter["passapp-engine-api/controllers:UserController"] = append(beego.GlobalControllerRouter["passapp-engine-api/controllers:UserController"],
		beego.ControllerComments{
			Method: "Post",
			Router: `/`,
			AllowHTTPMethods: []string{"post"},
